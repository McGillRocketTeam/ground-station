...
/**
 * LJMException is a custom exception class for the LJM class. It takes error and errorAddress
 * values returned from LJM library function calls, will get the string error from the LJM library
 * and setup exception strings with them.
 *
