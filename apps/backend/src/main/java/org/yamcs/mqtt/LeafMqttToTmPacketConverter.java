 ...
 *
 * <p>Messages are JSON objects with two fields: <code>timestamp</code> and <code>payload</code>.
 *
 * <p><code>timestamp</code> is UTC in ISO 8601 format and is used to set the Earth Reception Time
 * (ERT).
 *
 * <p><code>payload</code> is a string with the binary data encoded as a sequence of octets in
 * hexadecimal.
 *
 * <p>Example:
 *
